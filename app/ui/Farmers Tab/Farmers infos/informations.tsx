...
export default function Informations({ farmerId }: InformationsProps) {
  ...
  const InfoRow = ({ label, value, flagColor = 'text-gray-400' }: { label: string, value: string, flagColor?: string }) => (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <section>
          ...
          <div className="space-y-2">
            <InfoRow label="Niveau d'étude:" value={farmer.studyLevel || 'N/A'} />
            <InfoRow label="Langue(s):" value={farmer.languages?.join(', ') || 'N/A'} flagColor="text-red-500" />
            <InfoRow label="Dialecte(s):" value={farmer.dialects?.join(', ') || 'N/A'} />
          </div>
        </section>
        <section>
          ...
          <div className="space-y-2">
            ...
            <InfoRow label="Adresse 2:" value={farmer.address2 || 'N/A'} flagColor="text-red-500" />
        ...
        <section>
          ...
          <div className="space-y-2">
            ...
            <InfoRow label="Organization:" value={farmer.organization || 'N/A'} flagColor="text-red-500" />
