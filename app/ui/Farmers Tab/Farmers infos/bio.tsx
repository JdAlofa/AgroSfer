    ...
    <div className="bg-white rounded-lg p-6 mt-6 space-y-8">
      <section>
        ...
        <div className="space-y-4">
          ...
          <InfoRow label="Date de naissance:" value={farmer.birthdate} flagColor="text-red-500" />
          <InfoRow label="Numéro de téléphone:" value={farmer.phoneNumber} />
        </div>
      </section>

      <section>
        <h2 className="text-xl font-bold text-[#754C29] mb-6">Data collection</h2>
        <div className="space-y-4">
          <InfoRow label="Provider:" value={farmer.provider} />
          <InfoRow label="Submition date:" value={farmer.submissionDate} flagColor="text-red-500" />
        </div>
      </section>
    </div>
  )
